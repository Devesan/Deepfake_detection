...
def get_dataset_info(dataset, split):
  ...
  """
  #dataset = "home/gdevesan_gmail_com/datasets/processed_images"
  directory = os.path.join(dataset, split)
  if os.path.isdir(directory):
    logging.info("custom directory loading inplace ...")
...
def get_datasets(config):
  ...
  config.dataset = "/home/gdevesan_gmail_com/datasets/processed_images"#'home/gdevesan_gmail_com/datasets/processed_images'
  logging.info("custom directory loading inplace ...")
  logging.info(f"{config.dataset}")
