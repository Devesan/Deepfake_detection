...
def main():
    ...
    parser.add_argument('--name', type=str, default='deepfake_resnet_25', help='Name of this experiment.')
    parser.add_argument('--group', type=str, default='wandb_results_resnet', help='Group name of this experiment.')
    # Training
    ...
    parser.add_argument('--warmup_epochs', type=int, default=1, help='Number of warmup epochs with lower learning rate.')
    ...
    # Logging
    parser.add_argument('--wandb', action='store_false', help='Log to Weights&bBiases.')
    ...
    if jax.process_index() == 0:
        ...
        if args.wandb:
            wandb.init(entity='d3v',
                       project='deepfake_tpu',
                       config=args,
                       name=args.name,
